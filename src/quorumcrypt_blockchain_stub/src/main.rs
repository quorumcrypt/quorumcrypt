...
use quorum_proto::proxy_api::proxy_api_server::ProxyApiServer;
...
// impl BlockchainStub for QuorumcryptBlockchainStub {
...
// // It will mantain the connections from the quorum nodes and forward the messages (like a dispatcher)
// struct ProxyStub {
