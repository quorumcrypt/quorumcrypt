...
use quorum_schemes::groups::group::GroupOperations;
use quorum_schemes::{groups::group::GroupElement, scheme_types_impl::GroupDetails};
...
// "quorumcrypt_<commit ID of Linux 6.4>"" to a point on the respective elliptic curve.
...
fn main() {
    ...
    let seed: &str = "quorumcrypt_6995e2de6891c724bfeb2db33d7b87775f913ad1";
