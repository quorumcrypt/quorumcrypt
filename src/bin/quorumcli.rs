...
fn keygen(k: u16, n: u16, a: &str, dir: &str, new: bool) -> Result<(), Error> {
    ...
    for node_id in 0..n {
        ...
        // TODO: eventually here there could be a protocol for an online phase to send the information to the Quorumcrypt instances.
